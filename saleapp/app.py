...
# SQL
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:12345678@localhost/labsaledb?charser=utf8mb4'
...
def login():
    if request.method == 'POST':
        ...
        if username in users and users[username] == password:
            ...
            flash('Check your password or account')
